...
public class DevicesManagementAPI: APIBase {
  ...
  "data" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func updateServerProperties(did did: String, deviceProperties: [String:AnyObject], completion: ((data: MetadataEnvelope?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: Promise<MetadataEnvelope>
     */
    public class func updateServerProperties(did did: String, deviceProperties: [String:AnyObject]) -> Promise<MetadataEnvelope> {
        let deferred = Promise<MetadataEnvelope>.pendingPromise()
  ...
  "data" : {
    "key" : "{}"
     ...
     - returns: RequestBuilder<MetadataEnvelope> 
     */
    public class func updateServerPropertiesWithRequestBuilder(did did: String, deviceProperties: [String:AnyObject]) -> RequestBuilder<MetadataEnvelope> {
        var path = "/devicemgmt/devices/{did}/serverproperties"
        path = path.stringByReplacingOccurrencesOfString("{did}", withString: "\(did)", options: .LiteralSearch, range: nil)
        let URLString = ArtikCloudAPI.basePath + path
